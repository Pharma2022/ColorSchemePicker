...
document.getElementById("grid").addEventListener("click", e=>navigator.clipboard.writeText(e.target.dataset.color) )
...
const setHtml= data=>{
    ...
    <div class="colorName" "data-color="${item.hex.value}">${item.hex.value}</div> `).join(" ") 
